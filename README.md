...
I build AI that runs in the real world: **on-device & edge inference on constrained
hardware**, **LLM/agent/RAG systems**, and the full-stack apps that ship them to users.
Electronics & Communication Engineer (B.E.), 5+ years and 20+ projects across mobile,
web, and cloud.
...
| Project | What it is |
|---|---|
| **[models-edge-devices](https://github.com/youhanasheriff/models-edge-devices)** | Split-architecture edge AI: YOLO → LoRA-tuned TinyLlama on NPU/BPU; INT8/GGUF quantization, llama.cpp, MLX |
| **[pocket_ai](https://github.com/youhanasheriff/pocket_ai)** | Real-time YOLO11 obstacle detection for edge devices — depth estimation, spatial reasoning, spoken guidance (<30ms) |
...
**Languages:** TypeScript · Python · Dart · Rust · Kotlin
